let firstImage = document.getElementById('First_Main_Image')
let secondImage = document.getElementById('Second_Main_Image')
...
let fetchCart = JSON.parse(localStorage.getItem('cart')) || []
let productName = document.getElementById('productName')
let firstDollar = document.getElementById('firstDollar')
let secondDollar = document.getElementById('secondDollar')
let totalDollar = `${firstDollar.innerText}.${secondDollar.innerText}`
totalDollar = totalDollar*1

let addCart = document.getElementById('ADD_TO_CART')
